...
class ZarandokAppYoutubePlayerScaffold extends StatefulWidget {
  /// Creates [YoutubePlayerScaffold].
  const ZarandokAppYoutubePlayerScaffold({
    super.key,
  ...
  @override
  State<ZarandokAppYoutubePlayerScaffold> createState() => _ZarandokAppYoutubePlayerScaffoldState();
}

class _ZarandokAppYoutubePlayerScaffoldState extends State<ZarandokAppYoutubePlayerScaffold> {
