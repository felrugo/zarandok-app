...
class AboutPage extends StatelessWidget
{
  ...
  final String _gitlabURL = "https://gitlab.com/kicsibali/zarandok_app";
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: ListView(itemExtent: 50.0, children: <Widget>[
        ListTile(title: Text("ZarándokApp"), subtitle: Text("1.0.0"), leading: FlutterLogo(),),
        ...
        ListTile(title: Text("Gitlab Project"), subtitle: Text("Forráskód"), leading: Image.asset("assets/gitlogo.png"), onTap: (){ _launchURL(_gitlabURL); },),
